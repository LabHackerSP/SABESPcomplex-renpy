...
init:
  ...
  image bg sala_imprensa = "sala_imprensa.png"
  image bg black = "#000000"
  image fred laptop = "fred_laptop.png"
  image bg laptop = "laptop_bg.png"
  image bg computador = "computador.jpg"
  image bg computador2 = "computador2.jpg"
  image bg computador3 = "desktop3.jpg"
  image bg casa_fred = "casa.png"
  image bg perdeu = "perdeu.jpg"
...
label start:
  scene bg sala_imprensa

  a "Muito bem, vamos começar."
  
  scene bg laptop

  n "Você está sentado ao lado de algumas dezenas de jornalistas, a maior parte do Estado de São Paulo, alguns do resto do país e meia meia dúzia de gringos."
  ...
  n "O assessor retirou essa frase de uma das peças oficiais de publicidade da empresa, que tenta se recuperar em meio a uma das maiores crises de sua história. Com os níveis dos reservatórios críticos e nenhuma recuperação dos mananciais, você sabe que é uma questão de tempo até o colapso."
...
label go3_prisao:
  scene bg sala_imprensa #trocar
  show homens_de_preto
